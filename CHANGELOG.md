...
## [v1.6.4](https://github.com/Bryelmo/ds-entities/tree/1.6.4) - 2026-07-16

### Fixed

- Fixed NodeService query

### Chore

- Upgrade Strapi dependencies to ^5.44.0

### Chore

- Upgrade Axios dependencies to ^1.15.0 and fix security vulnerabilities

## [v1.6.3](https://github.com/Bryelmo/ds-entities/tree/1.6.3) - 2026-04-13
...
## [v1.6.2](https://github.com/Bryelmo/ds-entities/tree/1.6.2) - 2026-01-28

### Added

- Node Slug field now is editable but autogenerated if left empty

### Chore

- Upgrade Strapi dependencies to ^5.34.0 and fix security vulnerabilities
