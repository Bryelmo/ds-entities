...
## [v1.6.1](https://github.com/Bryelmo/ds-entities/tree/1.6.1) - 2025-12-18

###Fixed

- Cleaned build

## [v1.6.0](https://github.com/Bryelmo/ds-entities/tree/1.6.0) - 2025-12-18

### Chore

- Upgrade Strapi dependencies to ^5.33.0 and fix security vulnerabilities

## [v1.5.1](https://github.com/Bryelmo/ds-entities/tree/1.5.1) - 2025-10-30

### Fixed

- Entity Uid generation only for default locale

## [v1.5.0](https://github.com/Bryelmo/ds-entities/tree/1.5.0) - 2025-10-28
